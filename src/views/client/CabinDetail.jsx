...
const CabinDetail = () => {
  ...
  const packageCapacity = location.state?.packageCapacity || cabin.capacity; // Usamos la capacidad del paquete si está disponible
  console.log(cabin);
  ...
  const [isAlbumModalOpen, setIsAlbumModalOpen] = useState(false); // Estado para controlar el modal de álbum
  const [albumPhotos] = useState([
    cabin.image,
    "/images/cabin1.jpg",
    "/images/cabin2.jpg",
    "/images/cabin3.jpg",
      ...
      <div className="py-12 px-4">
        ...
        <div className="md:w-1/2 relative">
            ...
            <button
              ...
              className="absolute top-2 right-2 bg-black text-white px-3 py-1 rounded-lg text-sm hover:bg-gray-800"
            >
              Álbum
            </button>
            <div className="my-12">
        ...
        <Modal
          ...
          >
            <h2 className="text-xl font-bold mb-4">Álbum de fotos</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {albumPhotos.map((photo, index) => (
                <img
                  key={index}
                  src={photo}
                  alt={`Álbum foto ${index + 1}`}
