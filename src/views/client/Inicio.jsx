...
export default function Inicio() {
  ...
  setSelectedPackage({
    ...service,
    cleaningFee: service.cleaningFee || 50, // ejemplo de tarifa de limpieza
    guaranteeFee: service.guaranteeFee || 100, // ejemplo de tarifa de garantía
  });
  setOpenModal(true);
};
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-gray-100 rounded-lg shadow-md p-6 mb-6 text-center">
                          ...
                          <div className="flex flex-col md:flex-row justify-center items-center gap-6">
                            ...
                            {/* <div className="flex items-center gap-2 text-lg text-gray-600">
                              <FaMoneyBillWave className="text-green-600" />
                              <span>Tarifa de limpieza: S/.{selectedPackage.cleaningFee || 50}</span> {/* Ajuste de valor predeterminado */}
                            {/* </div> */}
                            {/* <div className="flex items-center gap-2 text-lg text-gray-600">
                              <FaMoneyBillWave className="text-green-600" />
                              <span>Tarifa de garantía: S/.{selectedPackage.guaranteeFee || 100}</span> {/* Ajuste de valor predeterminado */}
                            {/* </div> */}
                          </div>
                        </div>
